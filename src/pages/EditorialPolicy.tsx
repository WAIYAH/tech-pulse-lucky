      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-8">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">2.1 Verification & Sourcing</h3>
                <ul className="list-disc list-inside text-foreground space-y-2 ml-2">
              ...
              <div>
                <h3 className="font-semibold mb-2">2.2 Distinction Between News & Opinion</h3>
              ...
              <div>
                <h3 className="font-semibold mb-2">2.3 Corrections & Clarifications</h3>
                <p className="text-foreground">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">3.1 Financial Independence</h3>
                <p className="text-foreground">
              ...
              <div>
                <h3 className="font-semibold mb-2">3.2 Personal Conflicts</h3>
                <p className="text-foreground mb-2">
              ...
              <div>
                <h3 className="font-semibold mb-2">3.3 Source Protection</h3>
                <p className="text-foreground">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">4.1 Sponsored Content</h3>
                <p className="text-foreground mb-2">
              ...
              <div>
                <h3 className="font-semibold mb-2">4.2 Advertiser Relations</h3>
                <p className="text-foreground">
              ...
              <div>
                <h3 className="font-semibold mb-2">4.3 Affiliate Links</h3>
                <p className="text-foreground">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">5.1 Community Standards</h3>
                <p className="text-foreground mb-2">
              ...
              <div>
                <h3 className="font-semibold mb-2">5.2 Comment Moderation</h3>
                <p className="text-foreground">
              ...
              <div>
                <h3 className="font-semibold mb-2">5.3 User Content Ownership</h3>
                <p className="text-foreground">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">6.1 Protecting Privacy</h3>
                <p className="text-foreground mb-2">
              ...
              <div>
                <h3 className="font-semibold mb-2">6.2 Responsible Coverage of Sensitive Topics</h3>
                <p className="text-foreground mb-2">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">8.1 Content Integrity</h3>
                <p className="text-foreground mb-2">
              ...
              <div>
                <h3 className="font-semibold mb-2">8.2 Algorithmic Transparency</h3>
                <p className="text-foreground">
              ...
              <div>
                <h3 className="font-semibold mb-2">8.3 Social Media Conduct</h3>
                <p className="text-foreground">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">9.1 Educational & Informational Purpose</h3>
                <p className="text-foreground">
              ...
              <div>
                <h3 className="font-semibold mb-2">9.2 No Guarantee of Accuracy</h3>
                <p className="text-foreground">
              ...
              <div>
                <h3 className="font-semibold mb-2">9.3 Third-Party Content</h3>
                <p className="text-foreground">
              ...
              <div>
                <h3 className="font-semibold mb-2">9.4 Product & Service Reviews</h3>
                <p className="text-foreground">
              ...
              <div>
                <h3 className="font-semibold mb-2">9.5 Limitation of Liability</h3>
                <p className="text-foreground">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">10.1 Reporting Errors</h3>
                <p className="text-foreground">
              ...
              <div>
                <h3 className="font-semibold mb-2">10.2 Correction Response Time</h3>
                <p className="text-foreground">
              ...
              <div>
                <h3 className="font-semibold mb-2">10.3 Appeals & Editorial Review</h3>
                <p className="text-foreground">
